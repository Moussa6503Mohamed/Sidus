...
3. Upload begins `quarantined`. No admin button can override this. Future scanner worker must attest exact opaque object reference plus saved SHA-256 before it marks `scan_clean`.
